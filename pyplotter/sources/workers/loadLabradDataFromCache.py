...
class LoadLabradDataFromCacheThread(QtCore.QRunnable):
    ...
    def __init__(self, plotRef    : str,
        ...
        super(LoadLabradDataFromCacheThread, self).__init__()
        ...
        self.lastDependent = lastDependent
        self.plotId     = plotId
    ...
    def run(self) -> None:
        ...
        # print('#### plot Data', self.plotRef, data)
