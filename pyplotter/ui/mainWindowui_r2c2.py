...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidgetFolder.setMaximumSize(QtCore.QSize(1000, 200))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.labelDataBase.setMaximumSize(QtCore.QSize(150, 120))
        self.labelDataBase.setObjectName("labelDataBase")
        self.horizontalLayout.addWidget(self.labelDataBase)
        self.labelCurrentDataBase = QtWidgets.QLabel(self.layoutWidget)
        ...
        self.labelCurrentDataBase.setMaximumSize(QtCore.QSize(16777215, 120))
        font = QtGui.QFont()
        ...
        self.checkBoxHidden = CheckBoxHidden(self.layoutWidget)
        self.checkBoxHidden.setEnabled(True)
        self.checkBoxHidden.setMinimumSize(QtCore.QSize(0, 0))
        self.checkBoxHidden.setMaximumSize(QtCore.QSize(150, 120))
        ...
        self.checkBoxStared = CheckBoxStared(self.layoutWidget)
        ...
        self.checkBoxStared.setMaximumSize(QtCore.QSize(150, 120))
        ...
        self.tableWidgetDataBase = TableWidgetDatabase(self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.tableWidgetDataBase.setMaximumSize(QtCore.QSize(1000, 16777215))
        font = QtGui.QFont()
        font.setPointSize(8)
        ...
        self.labelRun = QtWidgets.QLabel(self.layoutWidget1)
        ...
        self.labelRun.setMaximumSize(QtCore.QSize(150, 120))
        self.labelRun.setObjectName("labelRun")
        self.horizontalLayout_3.addWidget(self.labelRun)
        self.labelCurrentRun = QtWidgets.QLabel(self.layoutWidget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.tableWidgetParameter = TableWidgetParameter(self.layoutWidget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.MinimumExpanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.labelMetadata = QtWidgets.QLabel(self.layoutWidget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.labelMetadata.setMaximumSize(QtCore.QSize(150, 120))
        self.labelMetadata.setObjectName("labelMetadata")
        self.horizontalLayout_2.addWidget(self.labelMetadata)
        self.labelCurrentSnapshot = QtWidgets.QLabel(self.layoutWidget1)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.labelSnapshot = LabelSnapshot(self.layoutWidget1)
        ...
        self.labelSnapshot.setMaximumSize(QtCore.QSize(150, 120))
        ...
        self.lineEditFilterSnapshot = LineEditSnapshot(self.layoutWidget1)
        ...
        self.groupBoxDataExplorer.setMaximumSize(QtCore.QSize(16777215, 120))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        ...
        self.pushButtonOpenFolder.setMaximumSize(QtCore.QSize(150, 50))
        font = QtGui.QFont()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.checkBoxHidden.setText(_translate("MainWindow", "Hidden"))
        self.checkBoxStared.setText(_translate("MainWindow", "Stared"))
        self.tableWidgetDataBase.setSortingEnabled(True)
        self.labelRun.setText(_translate("MainWindow", "Parameters:"))
