...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.checkBoxDerivative = QtWidgets.QCheckBox(self.groupBoxCalculus)
        font = QtGui.QFont()
        font.setBold(False)
        font.setWeight(50)
        self.checkBoxDerivative.setFont(font)
        self.checkBoxDerivative.setObjectName("checkBoxDerivative")
        self.horizontalLayout_3.addWidget(self.checkBoxDerivative)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.checkBoxDerivative.setText(_translate("Dialog", "Derivative"))
