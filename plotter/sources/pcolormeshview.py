...
from pyqtgraph.imageview.ImageViewTemplate_pyqt import Ui_Form
...
class PColorMeshView(QtGui.QWidget):
    """
    ...
    def __init__(self, parent=None, name="PColorMeshView", view=None, imageItem=None, 
                 levelMode='mono', *args):
        """
